var RENDERER = {
	POINT_INTERVAL : 3,//浪花震幅
	FISH_COUNT : 3,//同一時間魚數量
	MAX_INTERVAL_COUNT : 2,
	INIT_HEIGHT_RATE : 0.5,//海平面高度
	THRESHOLD : 50,//浪高
	...
	setup : function(){
		...
		this.skyGradient.addColorStop(0, 'hsl(201, 65%, 72%)');
		this.skyGradient.addColorStop(1, 'hsl(201, 65%, 72%)');
