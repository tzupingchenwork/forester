...
try {
    ...
    //內容
    $sql = "SELECT * FROM `plan` where memNo = $memNo and planStatus =1";
...
<!-- robot -->
    ...
    <div class="wrap">
     <!-- bg fly -->
     <div id="scene1">
        <div data-depth="0.8" class="fly1"><img src="images/leaf.svg" alt="樹葉"></div>
    </div>
       <script>
    ...
    <!-- blog share -->
     <!-- bg fly -->
     <div id="scene2">
        <div data-depth="0.6" class="fly1"><img src="images/leaf3.svg" alt="樹葉"></div>
    </div>
       <script>
    ...
    <div class="blogShare">
        <div class="blogShare-board">
            <img src="images/blog_bg2.png" alt="board">
        </div>
        ...
        <div class="blogSummit">
            <div class="blogSummit-pin">
              ...
              <!-- bg fly -->
                <div id="scene3">
                    <div data-depth="0.2" class="fly1"><img src="images/leaf2.svg" alt="樹葉"></div>
                </div>
                <script>
